  ...
  return (
    <div>
      <div className="d-flex justify-content-end mb-5">
        { openFilters ?
          <button onClick={closeFilters} className="btn btn-sm btn-danger ms-2">Close</button>
          :
          <button onClick={() => setOpenFilters(!openFilters)} className="btn btn-sm ms-2" style={{"backgroundColor":"white"}}>
